...
The cumulative accessibility modelling was calculated using the R5R library with R Programming Language. The library calculates accessibility by performing tree procedures. Next, each procedure is described, indicating the inputs required for each one:
