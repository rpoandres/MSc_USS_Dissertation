...
\begin{figure}[h]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Commecial corridor opportunities}
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Walking and BRT accessibility}
        \label{fig:Results_BRT}
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=1.3\linewidth]{Data/Results/Images/Metro_base.png}
        \caption{Walking and metro accessibility}
