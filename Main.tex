...
The use of modelling tools in the urban environment has gained popularity for analyzing high-complexity topics to support the decision-making process \citep{houApproachBuildingOccupancy2020}. As technology information developments have enabled greater processing capacities \citep{krainesIntegratingDistributedComputational2011}, a more multidisciplinary approach is now available when addressing built environment-related phenomena.
