...
ggplot(spatial_r5r_brt_1) +
  ggtitle("BRT accessibility: cutoffs = 30  max_walk_time = 30, max_trip_duration = 60") + 
  geom_sf(aes(fill = accessibility), color = NA) +
  scale_fill_viridis_c() +
  labs(fill = "Accessible\nHigh Street Retail") +
  #theme_minimal()
...
ggplot(spatial_r5r_metro_1) +
  ggtitle("Metro accessibility: cutoffs = 30  max_walk_time = 30, max_trip_duration = 60") + 
  geom_sf(aes(fill = accessibility), color = NA) +
  scale_fill_viridis_c() +
  labs(fill = "Accessible\nHigh Street Retail") +
  #theme_minimal()
...
ggplot(spatial_r5r_full_1) +
  ggtitle("BRT and Metro accessibility: cutoffs = 30  max_walk_time = 30, max_trip_duration = 60") + 
  geom_sf(aes(fill = accessibility), color = NA) +
  scale_fill_viridis_c() +
  labs(fill = "Accessible\nHigh Street Retail") +
  #theme_minimal()
