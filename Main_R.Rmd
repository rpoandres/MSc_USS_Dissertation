...
# 
# download.file(url,"20230620em2021.zip")
# 
# unzip("20230620em2021.zip")
# 
# survey_raw <- read_csv("20230620EM2021.csv")
```

Reading from local

```{r}
survey_raw <- read_csv("Data/Survey/CSV/20230620EM2021.csv")
```
Preview
