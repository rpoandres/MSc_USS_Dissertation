...
\begin{enumerate}
  ...
  \item Cellular automata and agent-based modelling: They aim to simulate the emergent aggregate result of individual agent-level actions in a system as agents interact with the environment and other agents. 
