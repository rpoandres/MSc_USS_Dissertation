...
ttm_max_walk_time <- 60 # minutes
ttm_max_trip_duration <- 150 # minutes
ttm_global_cutoff <- 30 # minutes

# R5R parameters
r5r_max_walk_time <- 60 # minutes
r5r_max_trip_duration <- 150 # minutes
r5r_global_cutoff <- 30 # minutes
```

## Walking mode

Considers just walkind mode.
...
```{r}
cum_cutoff_29_walk <- cumulative_cutoff(
  ttm_walk,
  land_use_data = hex_points_main,
  opportunity = "LU_COD_21",
  travel_cost = "travel_time",
...
ggplot(main_results_hex9) +
  ggtitle("Walking accessibility: cutoffs = 30  max_walk_time = 30, max_trip_duration = 120") +
...
```{r}
# R5R parameters
r5r_1_global_cutoff <- 60 # minutes
r5r_1_max_walk_time <- 30 # minutes
r5r_1_max_trip_duration <- 60 # minutes
