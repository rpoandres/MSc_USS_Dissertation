...
```{r}
spatial_access_brt <- merge(
  hex_grid_9,
  cum_opportunities_brt,
  by.x = "h3_index",
  by.y = "id"
)
```
...
```{r}
spatial_access_metro <- merge(
  hex_grid_9,
  cum_opportunities_metro,
  by.x = "h3_index",
  by.y = "id"
)
```
...
```{r}
spatial_access_full <- merge(
  hex_grid_9,
  cum_opportunities_full,
  by.x = "h3_index",
  by.y = "id"
)
```
...
```{r}
median(spatial_access_brt$LU_COD_21)
```
Max duration: 60 min
...
```{r}
median(spatial_access_metro$LU_COD_21)
```
Max duration: 60 min

```{r}
median(r5r_access_metro_1$accessibility)
```
...
```{r}
median(spatial_access_full$LU_COD_21)
```
Max duration: 60 min

```{r}
median(r5r_access_full_1$accessibility)
```
