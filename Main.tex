...
The first announcement of the construction of Bogota's future metro system was on XXXXXX by XXXX. On several occasions, the need for a higher-capacity public transportation system in Colombia's capital has taken great attention from the general public. The initial idea of building a metro in Bogotá goes back to the year 1942 when the current mayor at the time suggested the building of a new metro system as the functioning trolley car was highly demanded \citep{metrodebogotaHistoriaMetroBogota}. The previous versions of the project were unsuccessful in terms of their planning and compilation, however, each attempt reinforced the need of improving Bogota's public transportation system.

By XXXX, under the local administration of XXXXX, the intentions materialized in a new design and contracting process which led to the signing of the construction contract by XXXX.

The project consists of the construction of the first of two future metro lines. The scope of this research will only include the first metro line in the future scenario as the final designs of the second metro line have not been published yet. 

The first metro line will have a 23,9-kilometre length overground track with 16 stations. With an investment of X USD, the construction of the first line began in 2021 and is supposed to be finished and functional by 2028.
