...
# OSM network (Pedestrian network)
...
# Multipurpose survey (Socioeconomic data)
...
- Control scenario: Metro + Walking mode
...
Copy input files to directories
...
## Base (before) scenario: BRT + walking
...
## Control scenario: Metro + Walking 
...
Variations between scenarios are calculated.
...
The difference between scenarios is plotted to assess the accessibility impact between them.
...
Descriptive statistics of time travel matrix by mode.
...
Review of consistency of merge and values of time travel mode values across scenarios.
...
Upper quartile absolute variation
...
## By income decile before and after

In order to better compare the accessibility impact across different income groups, the before and after results are plotted in the same figure.
