...
for (i in names(items)) {
  ...
  write.table(get(i), file_path, sep=",", quote=FALSE)
}
```
...
```{r}
paths <- file.path(input_directory, items)
```

Set working directory

```{r}
#zip(zipfile = "test.zip", files = paths[1])
zip(zipfile = "Data/Preprocessed/Metro/GTFS/Final/Metro-GTFS.zip", files = list.files("Data/Preprocessed/Metro/GTFS/Inputs/", full.names = TRUE))
