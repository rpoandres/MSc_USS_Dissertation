...
ttm_global_cutoff <- 180 # minutes
ttm_max_walk_time <- 120 # minutes
ttm_max_trip_duration <- 180 # minutes


# R5R parameters
r5r_global_cutoff <- 180 # minutes
r5r_max_walk_time <- 120 # minutes
r5r_max_trip_duration <- 180 # minutes
```
