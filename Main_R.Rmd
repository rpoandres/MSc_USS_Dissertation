...
for (i in 2:(nrow(metro_stop_times))) {
...
metro_stop_times$stop_sequence <- 0

for (i in 1:(nrow(metro_stop_times))) {
  metro_stop_times$stop_sequence[i] = i
