...
```{r}
p_1 <- st_sfc(st_point(c(-74.17186, 4.630021))) %>% 
  st_set_crs(4326)

p_2 <- st_sfc(st_point(c(-74.16671, 4.622248))) %>% 
  st_set_crs(4326)
...
```{r}
p_15 <- st_sfc(st_point(c(-74.06168,4.660545))) %>% 
  st_set_crs(4326)

p_16 <- st_sfc(st_point(c(-74.17746,4.640571))) %>% 
  st_set_crs(4326)

st_distance(p_16 ,p_15)
```
...
```{r}
distance_stations_df <- data.frame(distance = unlist(distance_list))
```
