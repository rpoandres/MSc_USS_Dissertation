...
```{r}
metro_agency <- tibble::tribble(~agency_id,  ~agency_name, ~agency_url, ~agency_timezone, ~agency_lang, ~agency_phone,
...
Adjust station code and populate location_type and zone_id
